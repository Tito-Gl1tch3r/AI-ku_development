...
- **Doble condición** (ampliada): (1) el código está completo de verdad (sin placeholders, sin "luego lo completo"); (2) la auto-auditoría FINAL (audit + pentest) no encontró NADA sin corregir. Si cualquiera falla, sigues razonando — no emites a medias.
